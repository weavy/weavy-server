...
const _a = "auto", Tr = 1, Ys = 1.1, va = 0.1, ya = 10, rn = 0, Pa = 1.25, Js = 40, qs = 5, U = {
  INITIAL: 0,
  RUNNING: 1,
  PAUSED: 2,
  FINISHED: 3
...
h(Ua, "isThai");
function Li(a) {
  return Na(a) ? Ma(a) ? Da(a) ? ne.SPACE : ka(a) || Oa(a) || a === 95 ? ne.ALPHA_LETTER : ne.PUNCT : Ua(a) ? ne.THAI_LETTER : a === 160 ? ne.SPACE : ne.ALPHA_LETTER : ja(a) ? ne.HAN_LETTER : Fa(a) ? ne.KATAKANA_LETTER : Va(a) ? ne.HIRAGANA_LETTER : Ba(a) ? ne.HALFWIDTH_KATAKANA_LETTER : ne.ALPHA_LETTER;
}
...
let ar;
const Ga = new RegExp("\\p{M}+", "gu"), Ka = new RegExp("([.*+?^${}()|[\\]\\\\])|(\\p{P})|(\\s+)|(\\p{M})|(\\p{L})", "gu"), Xa = new RegExp("([^\\p{M}])\\p{M}*$", "u"), Za = new RegExp("^\\p{M}*([^\\p{M}])", "u"), Qa = /[\uAC00-\uD7AF\uFA6C\uFACF-\uFAD1\uFAD5-\uFAD7]+/g, or = /* @__PURE__ */ new Map(), Ya = "[\\u1100-\\u1112\\ud7a4-\\ud7af\\ud84a\\ud84c\\ud850\\ud854\\ud857\\ud85f]", lr = /* @__PURE__ */ new Map();
let an = null, on = null;
function ln(a) {
  const e = [];
  let t;
  ...
  if (e.length === 0 && an)
    ...
    const I = Object.keys(sr).join(""), L = Ha(), P = `([${I}])|([${L}])|((?:゙|゚)\\n)|(\\p{M}+(?:-\\n)?)|(\\p{Ll}-\\n\\p{Lu})|(\\S-\\n)|((?:\\p{Ideographic}|[぀-ヿ])\\n)|(\\n)`;
    e.length === 0 ? i = an = new RegExp(P + "|(\\u0000)", "gum") : i = on = new RegExp(P + `|(${Ya})`, "gum");
  }
  const n = [];
...
const Es = class Es {
  ...
  async render(e, t, i = "display") {
    ...
    this.annotationLayer = new no({
      ...
      hasJSActions: s,
      fieldObjects: r
    }), this.linkService.isInPresentationMode && u(this, Yt, xn).call(this, ft.FULLSCREEN), o(this, Le) || (f(this, Le, new AbortController()), this._eventBus?._on("presentationmodechanged", (c) => {
      u(this, Yt, xn).call(this, c.state);
    }, {
...
Qt = new WeakMap(), Le = new WeakMap(), Yt = new WeakSet(), xn = /* @__PURE__ */ h(function(e) {
  if (!this.div)
    return;
  let t = !1;
  switch (e) {
...
h(mo, "match");
function pr(a, e, t) {
  return e[t] ? Mt(a, e[t].value) : (a.reportError(new RangeError("No default")), new H());
}
h(pr, "getDefault");
function An(a, e) {
...
function bo(a, {
  ...
  if (a.params)
    ...
    return a.reportError(new ReferenceError(`Unknown variable: $${e}`)), new H(`$${e}`);
  if (t instanceof Nt)
    return t;
  switch (typeof t) {
    case "string":
    ...
    default:
      return a.reportError(new TypeError(`Variable type not supported: $${e}, ${typeof t}`)), new H(`$${e}`);
  }
}
...
function Eo(a, {
  ...
  if (!i)
    return a.reportError(new ReferenceError(`Unknown message: ${e}`)), new H(e);
  if (t) {
    const n = i.attributes[t];
    return n ? Mt(a, n) : (a.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new H(`${e}.${t}`));
  }
  return i.value ? Mt(a, i.value) : (a.reportError(new ReferenceError(`No value: ${e}`)), new H(e));
}
...
function wo(a, {
  ...
  if (!s)
    return a.reportError(new ReferenceError(`Unknown term: ${n}`)), new H(n);
  if (t) {
    ...
    return a.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new H(`${n}.${t}`);
  }
  a.params = An(a, i).named;
...
function _o(a, {
  ...
  if (!i)
    return a.reportError(new ReferenceError(`Unknown function: ${e}()`)), new H(`${e}()`);
  if (typeof i != "function")
    return a.reportError(new TypeError(`Function ${e}() is not callable`)), new H(`${e}()`);
  try {
    let n = An(a, t);
    return i(n.positional, n.named);
  } catch (n) {
    return a.reportError(n), new H(`${e}()`);
  }
}
...
function Br(a, e) {
  if (a.dirty.has(e))
    return a.reportError(new RangeError("Cyclic reference")), new H();
  a.dirty.add(e);
...
function Po(a, e) {
  let t = a[0];
  if (t instanceof H)
    return new H(`DATETIME(${t.valueOf()})`);
  if (t instanceof ht)
  ...
  formatPattern(e, t = null, i = null) {
    ...
    try {
      ...
      if (n.errors && s instanceof Error)
        return n.errors.push(s), new H().toString(n);
      throw s;
    }
  }
};
...
h(Yo, "keysFromBundle");
const ze = "data-l10n-id", jt = "data-l10n-args", Jo = `[${ze}]`, Ns = class Ns extends Mn {
  constructor(e, t) {
  ...
  getTranslatables(e) {
    const t = Array.from(e.querySelectorAll(Jo));
...
const ct = class ct {
  constructor({
    ...
    m(this, Q);
    var n, s;
    f(this, bt, u(n = ct, Ot, $r).call(n, e)), f(this, Q, i), f(this, Jt, t ?? u(s = ct, Ot, Wr).call(s, o(this, bt)) ? "rtl" : "ltr");
  }
  _setL10n(e) {
    f(this, Q, e);
  }
...
Jt = new WeakMap(), Te = new WeakMap(), bt = new WeakMap(), Q = new WeakMap(), Ot = new WeakSet(), $r = /* @__PURE__ */ h(function(e) {
...
h(cn, "getCurrentHash");
var Re, T, pe, ki, Oi, Bt, Di, Fn, Zr, Qr, Vn, Yr, Jr;
const Ms = class Ms {
  constructor({
    linkService: e,
    eventBus: t
  ...
  initialize({
    ...
    this._fingerprint = e, this._updateUrl = i === !0, this._initialized = !0, u(this, T, Yr).call(this);
  ...
  reset() {
    this._initialized && (u(this, T, Vn).call(this), this._initialized = !1, u(this, T, Jr).call(this)), this._updateViewareaTimeout && (clearTimeout(this._updateViewareaTimeout), this._updateViewareaTimeout = null), this._initialBookmark = null, this._initialRotation = null;
  }
  push({
    namedDest: e = null,
    explicitDest: t,
...
}, "#bindEvents"), Jr = /* @__PURE__ */ h(function() {
...
let Bn = ks;
{
  ...
  (function() {
    (n || i) && Un.set("maxCanvasPixels", 5242880);
  })(), (function() {
    i && Un.set("useSystemFonts", !1);
  })();
}
const g = {
  BROWSER: 1,
...
const se = class se {
  ...
  static setAll(e, t = !1) {
    ...
    for (const n in e) {
      const s = ce[n], r = e[n];
      if (!s || !(typeof r == typeof s.value || Hn[(typeof r).toUpperCase()] & s.type))
        continue;
      const {
        kind: l
      } = s;
...
let Zn = js;
var ri, ai, Qe, le, Y, Oe, en, ea, Dt, ta, ia;
const ge = class ge {
  constructor({
    pdfPage: e,
    highlighter: t = null,
...
ri = new WeakMap(), ai = new WeakMap(), Qe = new WeakMap(), le = new WeakMap(), Y = new WeakMap(), Oe = new WeakMap(), en = new WeakSet(), ea = /* @__PURE__ */ h(function(e) {
  var i;
  const {
    div: t
  } = this;
  t.addEventListener("mousedown", () => {
    ...
    Pn(n);
  }), o(ge, Y).set(t, e), u(i = ge, Dt, ia).call(i);
}, "#bindMouse"), Dt = new WeakSet(), ta = /* @__PURE__ */ h(function(e) {
  o(this, Y).delete(e), o(this, Y).size === 0 && (o(this, Oe)?.abort(), f(this, Oe, null));
  ...
  document.addEventListener("selectionchange", () => {
    ...
    for (let A = 0; A < r.rangeCount; A++) {
      ...
      for (const I of o(this, Y).keys())
        !l.has(I) && C.intersectsNode(I) && l.add(I);
    }
    for (const [A, C] of o(this, Y))
      l.has(A) ? A.classList.add("selecting") : t(C, A);
    if (n ??= getComputedStyle(o(this, Y).values().next().value).getPropertyValue("-moz-user-select") === "none", n)
      return;
    ...
    const E = p.parentElement?.closest(".textLayer"), w = o(this, Y).get(E);
...
}, "#enableGlobalSelectionListener"), m(ge, Dt), h(ge, "TextLayerBuilder"), m(ge, Y, /* @__PURE__ */ new Map()), m(ge, Oe, null);
let Zi = ge;
const Fs = class Fs {
  constructor({
    pdfPage: e,
...
var Ye, De, oi, Je, li, je, Fe, xt, hi, di, ui, qe, St, At, we, Ve, R, ut, Fi, Ut, Qn, Yn, Jn, qn, es, na, sa, ts, is;
const Vs = class Vs {
  constructor(e) {
    m(this, R);
    m(this, Ye, ye.ENABLE_FORMS);
    m(this, De, null);
    m(this, oi, !1);
    m(this, Je, !1);
    m(this, li, !1);
  ...
  update({
    ...
    if (this.viewport = this.viewport.clone({
      ...
      const l = n >= 0 && n < 1e3;
      if (l || r) {
        if (l && !r && this.renderingState !== U.FINISHED && (this.cancelRendering({
          keepAnnotationLayer: !0,
          keepAnnotationEditorLayer: !0,
          keepXfaLayer: !0,
          keepTextLayer: !0,
          cancelExtraDelay: n
        }), this.renderingState = U.FINISHED, o(this, we).directDrawing = !1), this.cssTransform({
  ...
  cssTransform({
    ...
    e && this.annotationLayer && u(this, R, Qn).call(this), t && this.annotationEditorLayer && (this.drawLayer && u(this, R, Jn).call(this), u(this, R, Yn).call(this)), i && this.xfaLayer && u(this, R, qn).call(this), this.textLayer && (s ? (this.textLayer.hide(), this.structTreeLayer?.hide()) : n && u(this, R, es).call(this));
  }
  get width() {
  ...
  async draw() {
    ...
    if (r || (r = f(this, De, document.createElement("div")), r.classList.add("canvasWrapper"), u(this, R, ut).call(this, r, "canvasWrapper")), !this.textLayer && o(this, At) !== ue.DISABLE && !n.isPureXfa && (this._accessibilityManager ||= new Kn(), this.textLayer = new Zi({
    ...
    })), !this.annotationLayer && o(this, Ye) !== ye.DISABLE) {
      const {
        annotationStorage: v,
      ...
      this._annotationCanvasMap ||= /* @__PURE__ */ new Map(), this.annotationLayer = new Wi({
        ...
        annotationStorage: v,
        imageResourcesPath: this.imageResourcesPath,
        renderForms: o(this, Ye) === ye.ENABLE_FORMS,
        linkService: ba,
        downloadManager: Z,
        enableScripting: K,
        hasJSActionsPromise: ma,
    ...
    const l = /* @__PURE__ */ h((v) => {
      if (C?.(!1), this.renderingQueue && !this.renderingQueue.isHighestPriority(this)) {
        this.renderingState = U.PAUSED, this.resume = () => {
          this.renderingState = U.RUNNING, v();
        };
        return;
      }
      v();
    ...
    if (this.maxCanvasPixels === 0) {
      ...
      L.sx *= v, L.sy *= v, f(this, Je, !0);
    } else if (this.maxCanvasPixels > 0) {
      const v = d * c, O = Math.sqrt(this.maxCanvasPixels / v);
      L.sx > O || L.sy > O ? (L.sx = O, L.sy = O, f(this, Je, !0)) : f(this, Je, !1);
    }
    ...
    const _ = b.promise.then(async () => {
      ...
      v && (this.drawLayer ||= new Wn({
        pageIndex: this.id
      }), await u(this, R, Jn).call(this), this.drawLayer.setParent(r), this.annotationEditorLayer ||= new Bn({
        uiManager: v,
        pdfPage: n,
        l10n: t,
...
Ye = new WeakMap(), De = new WeakMap(), oi = new WeakMap(), Je = new WeakMap(), li = new WeakMap(), je = new WeakMap(), Fe = new WeakMap(), xt = new WeakMap(), hi = new WeakMap(), di = new WeakMap(), ui = new WeakMap(), qe = new WeakMap(), St = new WeakMap(), At = new WeakMap(), we = new WeakMap(), Ve = new WeakMap(), R = new WeakSet(), ut = /* @__PURE__ */ h(function(e, t) {
  ...
  uo(this.div, e, !0, !1);
}, "#setDimensions"), Ut = /* @__PURE__ */ h(function(e, t) {
  ...
  try {
    ...
    u(this, R, Ut).call(this, "annotationlayerrendered", e);
  }
}, "#renderAnnotationLayer"), Yn = /* @__PURE__ */ h(async function() {
  let e = null;
  try {
    ...
    u(this, R, Ut).call(this, "annotationeditorlayerrendered", e);
  }
}, "#renderAnnotationEditorLayer"), Jn = /* @__PURE__ */ h(async function() {
  try {
  ...
  try {
    ...
    this.xfaLayer?.div && (this.l10n.pause(), u(this, R, ut).call(this, this.xfaLayer.div, "xfaLayer"), this.l10n.resume()), u(this, R, Ut).call(this, "xfalayerrendered", e);
  }
  ...
  u(this, R, Ut).call(this, "textlayerrendered", e), u(this, R, na).call(this);
  ...
  if (f(this, qe, t), this.renderingState = U.FINISHED, o(this, we).regularAnnotations = !e.separateAnnots, this.eventBus.dispatch("pagerendered", {
    source: this,
    pageNumber: this.id,
    cssTransform: !1,
    timestamp: performance.now(),
...
let ns = Bs;
var he, et, ci, tt, it, fi, X, _e, It, $, ie, z, ra, Vi, rs, aa, Ht;
const Us = class Us {
  constructor({
    eventBus: e,
  ...
  async setDocument(e) {
    ...
    try {
      ...
      console.error("setDocument:", l), await u(this, z, Ht).call(this);
      return;
    }
    const s = o(this, it);
...
he = new WeakMap(), et = new WeakMap(), ci = new WeakMap(), tt = new WeakMap(), it = new WeakMap(), fi = new WeakMap(), X = new WeakMap(), _e = new WeakMap(), It = new WeakMap(), $ = new WeakMap(), ie = new WeakMap(), z = new WeakSet(), ra = /* @__PURE__ */ h(async function(e) {
  ...
  if (s?.renderingState !== U.FINISHED) {
...
}, "#initScripting"), Ht = /* @__PURE__ */ h(async function() {
  if (!o(this, $)) {
...
}, "#destroyScripting"), h(Us, "PDFScriptingManager");
let ss = Us;
const Hs = class Hs extends ss {
  constructor(e) {
...
h(Hs, "PDFScriptingManagerComponents");
let as = Hs;
...
function Lr(a) {
  return Object.values(J).includes(a) && a !== J.DISABLE;
}
...
let ls = Ws;
var Be, gi, mi, de, q, st, bi, Ei, wi, _i, vi, yi, Pi, Ue, rt, at, ot, Lt, He, Tt, xi, Rt, lt, $e, Si, Ct, S, oa, la, ha, $t, Bi, da, ds, ua, xe, us, ca, fa, pa, cs, ga, Ui;
const zs = class zs {
  constructor(e) {
    m(this, S);
    m(this, Be, null);
...
`);
  ...
  setDocument(e) {
    ...
    r._on("pagerendered", E, {
      ...
      if (L !== ue.DISABLE) {
        const P = f(this, He, document.createElement("div"));
        P.id = "hiddenCopyElement", d.before(P);
      }
      if (typeof AbortSignal.any == "function" && C !== J.DISABLE) {
        const P = C;
        e.isPureXfa ? console.warn("Warning: XFA-editing is not implemented.") : Lr(P) ? (f(this, q, new io(this.container, d, o(this, gi), r, e, l, o(this, mi), o(this, _i), o(this, yi), o(this, Pi), o(this, rt), o(this, Ei), o(this, Si))), r.dispatch("annotationeditoruimanager", {
          source: this,
          uiManager: o(this, q)
        }), P !== J.NONE && (P === J.STAMP && o(this, rt)?.loadModel("altText"), o(this, q).updateMode(P))) : console.error(`Invalid AnnotationEditor mode: ${P}`);
      }
      ...
      this._pages[0]?.setPdfPage(w), this._scrollMode === D.PAGE ? u(this, S, $t).call(this) : this._spreadMode !== G.NONE && this._updateSpreadMode(), u(this, S, la).call(this, c).then(async () => {
        if (e !== this.pdfDocument)
          return;
        if (this.findController?.setDocument(e), this._scriptingManager?.setDocument(e), o(this, He) && document.addEventListener("copy", u(this, S, ha).bind(this, L), {
          signal: c
  ...
  _resetView() {
    this._pages = [], this._currentPageNumber = 1, this._currentScale = rn, this._currentScaleValue = null, this._pageLabels = null, f(this, Be, new ls(Ir)), this._location = null, this._pagesRotation = 0, this._optionalContentConfigPromise = null, this._firstPageCapability = Promise.withResolvers(), this._onePageRenderedCapability = Promise.withResolvers(), this._pagesCapability = Promise.withResolvers(), this._scrollMode = D.VERTICAL, this._previousScrollMode = D.UNKNOWN, this._spreadMode = G.NONE, f(this, lt, {
      ...
      scrollDown: !0,
      pages: []
    }), o(this, Ue)?.abort(), f(this, Ue, null), this.viewer.textContent = "", this._updateScrollMode(), this.viewer.removeAttribute("lang"), o(this, He)?.remove(), f(this, He, null), u(this, S, Ui).call(this);
  }
  _scrollUpdate() {
  ...
  get annotationEditorMode() {
    return o(this, q) ? o(this, de) : J.DISABLE;
  }
  set annotationEditorMode({
    ...
    if (!this.pdfDocument)
      return;
    e === J.STAMP && o(this, rt)?.loadModel("altText");
    const {
      eventBus: n
    } = this, s = /* @__PURE__ */ h(() => {
      u(this, S, Ui).call(this), f(this, de, e), o(this, q).updateMode(e, t, i), n.dispatch("annotationeditormodechanged", {
        source: this,
        mode: e
      });
    }, "updater");
    if (e === J.NONE || o(this, de) === J.NONE) {
      const r = e !== J.NONE;
      ...
      if (r && l) {
        u(this, S, Ui).call(this), f(this, at, new AbortController());
        const d = AbortSignal.any([o(this, Ue).signal, o(this, at).signal]);
        n._on("pagerendered", ({
          pageNumber: c
        }) => {
...
Be = new WeakMap(), gi = new WeakMap(), mi = new WeakMap(), de = new WeakMap(), q = new WeakMap(), st = new WeakMap(), bi = new WeakMap(), Ei = new WeakMap(), wi = new WeakMap(), _i = new WeakMap(), vi = new WeakMap(), yi = new WeakMap(), Pi = new WeakMap(), Ue = new WeakMap(), rt = new WeakMap(), at = new WeakMap(), ot = new WeakMap(), Lt = new WeakMap(), He = new WeakMap(), Tt = new WeakMap(), xi = new WeakMap(), Rt = new WeakMap(), lt = new WeakMap(), $e = new WeakMap(), Si = new WeakMap(), Ct = new WeakMap(), S = new WeakSet(), oa = /* @__PURE__ */ h(function(e) {
  const t = {
    annotationEditorMode: o(this, de),
    annotationMode: o(this, st),
    textLayerMode: o(this, Ct)
  };
  return e && (!e.includes(Ti.COPY) && o(this, Ct) === ue.ENABLE && (t.textLayerMode = ue.ENABLE_PERMISSIONS), e.includes(Ti.MODIFY_CONTENTS) || (t.annotationEditorMode = J.DISABLE), !e.includes(Ti.MODIFY_ANNOTATIONS) && !e.includes(Ti.FILL_INTERACTIVE_FORMS) && o(this, st) === ye.ENABLE_FORMS && (t.annotationMode = ye.ENABLE)), t;
...
}, "#resizeObserverCallback"), Ui = /* @__PURE__ */ h(function() {
...
let fs = Gs;
var Ml = V.AnnotationLayerBuilder, kl = V.DownloadManager, Ol = V.EventBus, Dl = V.FindState, jl = V.GenericL10n, Fl = V.LinkTarget, Vl = V.PDFFindController, Bl = V.PDFHistory, Ul = V.PDFLinkService, Hl = V.PDFPageView, $l = V.PDFScriptingManager, Wl = V.PDFSinglePageViewer, zl = V.PDFViewer, Gl = V.ProgressBar, Kl = V.RenderingStates, Xl = V.ScrollMode, Zl = V.SimpleLinkService, Ql = V.SpreadMode, Yl = V.StructTreeLayerBuilder, Jl = V.TextLayerBuilder, ql = V.XfaLayerBuilder, eh = V.parseQueryString;
export {
  ...
  Ql as SpreadMode,
  Yl as StructTreeLayerBuilder,
  Jl as TextLayerBuilder,
