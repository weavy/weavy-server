...
var o = (i, e) => Ut(i, "name", { value: e, configurable: !0 });
const Pe = "lit-localize-status";
const kt = /* @__PURE__ */ o((i, ...e) => ({
  strTag: !0,
  strings: i,
  values: e
}), "_str"), l = kt, Nt = /* @__PURE__ */ o((i) => typeof i != "string" && "strTag" in i, "isStrTagged"), $t = /* @__PURE__ */ o((i, e, t) => {
  let s = i[0];
  for (let n = 1; n < i.length; n++)
    s += e[t ? t[n - 1] : n - 1], s += i[n];
  return s;
}, "joinStringsAndValues");
const Et = /* @__PURE__ */ o(((i) => Nt(i) ? $t(i.strings, i.values) : i), "defaultMsg");
let xt = Et, st = !1;
function Ot(i) {
  if (st)
...
o(Ve, "LocalizeController");
let Te = Ve;
const It = /* @__PURE__ */ o((i) => i.addController(new Te(i)), "_updateWhenLocaleChanges"), Ht = It;
const vs = /* @__PURE__ */ o(() => (i, e) => (i.addInitializer(Ht), i), "localized");
const ze = class ze {
  constructor() {
...
const S = [];
for (let i = 0; i < 256; i++)
  S[i] = (i >> 4 & 15).toString(16) + (i & 15).toString(16);
function Dt(i) {
  ...
  return S[d >> 8] + S[d & 255] + S[a >> 8] + S[a & 255] + S[n >> 8] + S[n & 255] + S[t >> 8] + S[t & 255];
}
o(Dt, "fnv1a64");
const jt = "", Ft = "h", Wt = "s";
function Bt(i, e) {
  return (e ? Ft : Wt) + Dt(typeof i == "string" ? i : i.join(jt));
}
o(Bt, "generateMsgId");
const it = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new Map();
function Vt(i, e, t) {
  if (i) {
    const s = t?.id ?? zt(e), n = i[s];
    if (n) {
      if (typeof n == "string")
        return n;
      if ("strTag" in n)
      ...
      {
        let r = it.get(n);
        return r === void 0 && (r = n.values, it.set(n, r)), {
          ...n,
...
function zt(i) {
  ...
  let t = nt.get(e);
  return t === void 0 && (t = Bt(e, typeof i != "string" && !("strTag" in i)), nt.set(e, t)), t;
}
o(zt, "generateId");
function Ae(i) {
...
let fe = "", ye, vt, ue, Re, At, M = new ce();
M.resolve();
let ae = 0;
const As = /* @__PURE__ */ o((i) => (Ot(((e, t) => Vt(At, e, t))), fe = vt = i.sourceLocale, ue = new Set(i.targetLocales), ue.add(i.sourceLocale), Re = i.loadLocale, { getLocale: Gt, setLocale: Kt }), "configureLocalization"), Gt = /* @__PURE__ */ o(() => fe, "getLocale"), Kt = /* @__PURE__ */ o((i) => {
  if (i === (ye ?? fe))
    return M.promise;
  if (!ue || !Re)
  ...
  ae++;
  const e = ae;
  return ye = i, M.settled && (M = new ce()), Ae({ status: "loading", loadingLocale: i }), (i === vt ? (
    // We could switch to the source locale synchronously, but we prefer to
    // queue it on a microtask so that switching locales is consistently
    // asynchronous.
    Promise.resolve({ templates: void 0 })
  ) : Re(i)).then((s) => {
    ae === e && (fe = i, ye = void 0, At = s.templates, Ae({ status: "ready", readyLocale: i }), M.resolve());
  }, (s) => {
    ae === e && (Ae({
      status: "error",
      errorLocale: i,
...
}, k, oe, de, Y, Se, Z, le, R, J, P, he, rt;
const at = /* @__PURE__ */ o((i) => typeof i == "boolean" ? i : i?.capture ?? !1, "isCaptureEventListener"), pe = 0, Le = 1, ge = 2, Me = 3, Ge = class Ge {
  constructor() {
  ...
  addEventListener(e, t, s) {
    if (t == null)
      return;
    const n = at(s) ? this.__captureEventListeners : this.__eventListeners;
    let r = n.get(e);
    if (r === void 0)
  ...
  removeEventListener(e, t, s) {
    if (t == null)
      return;
    const n = at(s) ? this.__captureEventListeners : this.__eventListeners, r = n.get(e);
  ...
  dispatchEvent(e) {
    ...
    if (e.composed)
      ...
      for (; s && s !== this.__host; )
        t.push(s), s = s.__eventTargetParent;
    let n = !1, r = !1, a = pe, h = null, d = null, f = null;
    ...
    const v = /* @__PURE__ */ o((g, y, q) => {
      typeof g == "function" ? g(e) : typeof g?.handleEvent == "function" && g.handleEvent(e), y.once && q.delete(g);
    }, "invokeEventListener"), $ = /* @__PURE__ */ o(() => (f = null, a = pe, !e.defaultPrevented), "finishDispatch"), w = t.slice().reverse();
    h = !this.__host || !e.composed ? this : null;
    const tt = /* @__PURE__ */ o((g) => {
      for (d = this; d.__host && g.includes(d.__host); )
        d = d.__host;
    }, "retarget");
    for (const g of w) {
      !h && (!d || d === g.__host) && tt(w.slice(w.indexOf(g))), f = g, a = g === e.target ? ge : Le;
    ...
    d = null;
    for (const g of Ee) {
      !h && (!d || g === d.__host) && tt(Ee.slice(0, Ee.indexOf(g) + 1)), f = g, a = g === e.target ? ge : Me;
...
o(Ge, "EventTarget");
let Ce = Ge;
const Yt = Ce, c = { __proto__: null };
c.enumerable = !0;
Object.freeze(c);
var I;
const De = (P = (I = class {
  constructor(e, t = {}) {
    if (k.set(this, !1), oe.set(this, !1), de.set(this, !1), Y.set(this, !1), Se.set(this, Date.now()), Z.set(this, !1), le.set(this, void 0), R.set(this, void 0), J.set(this, void 0), this.NONE = pe, this.CAPTURING_PHASE = Le, this.AT_TARGET = ge, this.BUBBLING_PHASE = Me, arguments.length === 0)
      throw new Error("The type argument must be specified");
    if (typeof t != "object" || !t)
      throw new Error('The "options" argument must be an object');
    const { bubbles: s, cancelable: n, composed: r } = t;
    A(this, k, !!n, "f"), A(this, oe, !!s, "f"), A(this, de, !!r, "f"), A(this, le, `${e}`, "f"), A(this, R, null, "f"), A(this, J, !1, "f");
  }
  initEvent(e, t, s) {
  ...
  get defaultPrevented() {
    return b(this, k, "f") && b(this, Y, "f");
  }
  get timeStamp() {
    return b(this, Se, "f");
  }
  composedPath() {
    return b(this, J, "f") ? [b(this, R, "f")] : [];
  }
  get returnValue() {
    return !b(this, k, "f") || !b(this, Y, "f");
  }
  ...
  get eventPhase() {
    return b(this, J, "f") ? P.AT_TARGET : P.NONE;
  }
  get cancelBubble() {
    return b(this, Z, "f");
  }
...
}, o(I, "Event"), I), k = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), P.NONE = pe, P.CAPTURING_PHASE = Le, P.AT_TARGET = ge, P.BUBBLING_PHASE = Me, P);
...
var H;
const yt = (rt = (H = class extends De {
  constructor(e, t = {}) {
    super(e, t), he.set(this, void 0), A(this, he, t?.detail ?? null, "f");
  }
...
}, o(H, "CustomEvent"), H), he = /* @__PURE__ */ new WeakMap(), rt);
...
E = (D = class {
  constructor() {
    this.STYLE_RULE = 1, this.CHARSET_RULE = 2, this.IMPORT_RULE = 3, this.MEDIA_RULE = 4, this.FONT_FACE_RULE = 5, this.PAGE_RULE = 6, this.NAMESPACE_RULE = 10, this.KEYFRAMES_RULE = 7, this.KEYFRAME_RULE = 8, this.SUPPORTS_RULE = 12, this.COUNTER_STYLE_RULE = 11, this.FONT_FEATURE_VALUES_RULE = 14, this.__parentStyleSheet = null, this.cssText = "";
  }
  get parentRule() {
    return null;
  }
...
}, o(D, "CSSRule"), D), E.STYLE_RULE = 1, E.CHARSET_RULE = 2, E.IMPORT_RULE = 3, E.MEDIA_RULE = 4, E.FONT_FACE_RULE = 5, E.PAGE_RULE = 6, E.NAMESPACE_RULE = 10, E.KEYFRAMES_RULE = 7, E.KEYFRAME_RULE = 8, E.SUPPORTS_RULE = 12, E.COUNTER_STYLE_RULE = 11, E.FONT_FEATURE_VALUES_RULE = 14;
globalThis.Event ??= Zt;
globalThis.CustomEvent ??= Jt;
const ot = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ o((i) => {
  let e = ot.get(i);
  return e === void 0 && ot.set(i, e = /* @__PURE__ */ new Map()), e;
}, "attributesForElement");
var j;
const Xt = (j = class extends Yt {
  constructor() {
    super(...arguments), this.__shadowRootMode = null, this.__shadowRoot = null, this.__internals = null;
  }
  get attributes() {
    return Array.from(X(this)).map(([e, t]) => ({
      name: e,
      value: t
    }));
  }
  ...
  getAttribute(e) {
    return X(this).get(e) ?? null;
  }
}, o(j, "Element"), j);
var F;
const Qt = (F = class extends Xt {
}, o(F, "HTMLElement"), F), St = Qt;
globalThis.litServerRoot ??= Object.defineProperty(new St(), "localName", {
...
const Ke = class Ke {
  ...
  async whenDefined(e) {
    ...
    return s || (s = es(), this.__pendingWhenDefineds.set(e, s)), s.promise;
  }
};
o(Ke, "CustomElementRegistry");
let Ue = Ke;
const ts = Ue, ss = new ts();
const ee = globalThis, je = ee.ShadowRoot && (ee.ShadyCSS === void 0 || ee.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fe = Symbol(), dt = /* @__PURE__ */ new WeakMap();
var W;
let wt = (W = class {
  constructor(e, t, s) {
...
const is = /* @__PURE__ */ o((i) => new wt(typeof i == "string" ? i : i + "", void 0, Fe), "r$2"), ys = /* @__PURE__ */ o((i, ...e) => {
  const t = i.length === 1 ? i[0] : e.reduce((s, n, r) => s + ((a) => {
    if (a._$cssResult$ === !0) return a.cssText;
    if (typeof a == "number") return a;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + a + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + i[r + 1], i[0]);
  return new wt(t, i, Fe);
}, "i$2"), ns = /* @__PURE__ */ o((i, e) => {
  if (je) i.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of e) {
    const s = document.createElement("style"), n = ee.litNonce;
    n !== void 0 && s.setAttribute("nonce", n), s.textContent = t.cssText, i.appendChild(s);
  }
}, "S$1"), lt = je || ee.CSSStyleSheet === void 0 ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const s of e.cssRules) t += s.cssText;
  return is(t);
})(i) : i, { is: rs, defineProperty: as, getOwnPropertyDescriptor: os, getOwnPropertyNames: ds, getOwnPropertySymbols: ls, getPrototypeOf: hs } = Object, re = globalThis;
re.customElements ??= ss;
const ht = re.trustedTypes, cs = ht ? ht.emptyScript : "", fs = re.reactiveElementPolyfillSupport, te = /* @__PURE__ */ o((i, e) => i, "f$1"), ke = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? cs : null;
      break;
  ...
  return t;
} }, Pt = /* @__PURE__ */ o((i, e) => !rs(i, e), "m$1"), ct = { attribute: !0, type: String, converter: ke, reflect: !1, useDefault: !1, hasChanged: Pt };
Symbol.metadata ??= Symbol("metadata"), re.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
var B;
let N = (B = class extends (globalThis.HTMLElement ?? St) {
  ...
  static getPropertyDescriptor(e, t, s) {
    const { get: n, set: r } = os(this.prototype, e) ?? { get() {
      return this[t];
    }, set(a) {
      this[t] = a;
    } };
  ...
  requestUpdate(e, t, s, n = !1, r) {
    if (e !== void 0) {
      ...
      if (n === !1 && (r = this[e]), s ??= a.getPropertyOptions(e), !((s.hasChanged ?? Pt)(r, t) || s.useDefault && s.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(a._$Eu(e, s)))) return;
      this.C(e, t, s);
    }
...
N.elementStyles = [], N.shadowRootOptions = { mode: "open" }, N[te("elementProperties")] = /* @__PURE__ */ new Map(), N[te("finalized")] = /* @__PURE__ */ new Map(), fs?.({ ReactiveElement: N }), (re.reactiveElementVersions ??= []).push("2.1.2");
const $e = globalThis, ft = /* @__PURE__ */ o((i) => i, "i$1"), me = $e.trustedTypes, ut = me ? me.createPolicy("lit-html", { createHTML: /* @__PURE__ */ o((i) => i, "createHTML") }) : void 0, Tt = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, Rt = "?" + T, us = `<${Rt}>`, U = $e.document === void 0 ? { createTreeWalker: /* @__PURE__ */ o(() => ({}), "createTreeWalker") } : document, se = /* @__PURE__ */ o(() => U.createComment(""), "c"), ie = /* @__PURE__ */ o((i) => i === null || typeof i != "object" && typeof i != "function", "a"), We = Array.isArray, ps = /* @__PURE__ */ o((i) => We(i) || typeof i?.[Symbol.iterator] == "function", "d"), we = `[ 	
\f\r]`, Q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pt = /-->/g, gt = />/g, L = RegExp(`>|${we}(?:([^\\s"'>=/]+)(${we}*=${we}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), mt = /'/g, _t = /"/g, Lt = /^(?:script|style|textarea|title)$/i, Mt = /* @__PURE__ */ o((i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), "x"), p = Mt(1), Ss = Mt(2), V = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), bt = /* @__PURE__ */ new WeakMap(), C = U.createTreeWalker(U, 129);
function Ct(i, e) {
  if (!We(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return ut !== void 0 ? ut.createHTML(e) : e;
}
o(Ct, "V");
const gs = /* @__PURE__ */ o((i, e) => {
  const t = i.length - 1, s = [];
  let n, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", a = Q;
  for (let h = 0; h < t; h++) {
    const d = i[h];
    let f, m, u = -1, v = 0;
    for (; v < d.length && (a.lastIndex = v, m = a.exec(d), m !== null); ) v = a.lastIndex, a === Q ? m[1] === "!--" ? a = pt : m[1] !== void 0 ? a = gt : m[2] !== void 0 ? (Lt.test(m[2]) && (n = RegExp("</" + m[2], "g")), a = L) : m[3] !== void 0 && (a = L) : a === L ? m[0] === ">" ? (a = n ?? Q, u = -1) : m[1] === void 0 ? u = -2 : (u = a.lastIndex - m[2].length, f = m[1], a = m[3] === void 0 ? L : m[3] === '"' ? _t : mt) : a === _t || a === mt ? a = L : a === pt || a === gt ? a = Q : (a = L, n = void 0);
    const $ = a === L && i[h + 1].startsWith("/>") ? " " : "";
    r += a === Q ? d + us : u >= 0 ? (s.push(f), d.slice(0, u) + Tt + d.slice(u) + T + $) : d + T + (u === -2 ? h : $);
  }
  return [Ct(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), s];
}, "N"), _e = class _e {
  constructor({ strings: e, _$litType$: t }, s) {
    let n;
    this.parts = [];
    let r = 0, a = 0;
    const h = e.length - 1, d = this.parts, [f, m] = gs(e, t);
    if (this.el = _e.createElement(f, s), C.currentNode = this.el.content, t === 2 || t === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (n = C.nextNode()) !== null && d.length < h; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const u of n.getAttributeNames()) if (u.endsWith(Tt)) {
          const v = m[a++], $ = n.getAttribute(u).split(T), w = /([.?@])?(.*)/.exec(v);
          d.push({ type: 1, index: r, name: w[2], strings: $, ctor: w[1] === "." ? xe : w[1] === "?" ? Oe : w[1] === "@" ? Ie : K }), n.removeAttribute(u);
        } else u.startsWith(T) && (d.push({ type: 6, index: r }), n.removeAttribute(u));
        if (Lt.test(n.tagName)) {
          const u = n.textContent.split(T), v = u.length - 1;
          if (v > 0) {
            n.textContent = me ? me.emptyScript : "";
            for (let $ = 0; $ < v; $++) n.append(u[$], se()), C.nextNode(), d.push({ type: 2, index: ++r });
            n.append(u[v], se());
          }
        }
      } else if (n.nodeType === 8) if (n.data === Rt) d.push({ type: 2, index: r });
      else {
        let u = -1;
        for (; (u = n.data.indexOf(T, u + 1)) !== -1; ) d.push({ type: 7, index: r }), u += T.length - 1;
      }
      r++;
    }
  }
...
function z(i, e, t = i, s) {
  ...
  return n?.constructor !== r && (n?._$AO?.(!1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, t, s)), s !== void 0 ? (t._$Co ??= [])[s] = n : t._$Cl = n), n !== void 0 && (e = z(i, n._$AS(i, e.values), n, s)), e;
}
o(z, "M");
const qe = class qe {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: s } = this._$AD, n = (e?.creationScope ?? U).importNode(t, !0);
    C.currentNode = n;
    let r = C.nextNode(), a = 0, h = 0, d = s[0];
    for (; d !== void 0; ) {
      if (a === d.index) {
        let f;
        d.type === 2 ? f = new G(r, r.nextSibling, this, e) : d.type === 1 ? f = new d.ctor(r, d.name, d.strings, this, e) : d.type === 6 && (f = new He(r, this, e)), this._$AV.push(f), d = s[++h];
      }
      a !== d?.index && (r = C.nextNode(), a++);
    }
    return C.currentNode = U, n;
  }
  p(e) {
    let t = 0;
...
const be = class be {
  ...
  _$AI(e, t = this) {
    e = z(this, e, t), ie(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== V && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ps(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== _ && ie(this._$AH) ? this._$AA.nextSibling.data = e : this.T(U.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: s } = e, n = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = ne.createElement(Ct(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === n) this._$AH.p(t);
    else {
      const r = new Ne(n, this), a = r.u(this.options);
      r.p(t), this.T(a), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = bt.get(e.strings);
    return t === void 0 && bt.set(e.strings, t = new ne(e)), t;
  }
  k(e) {
    We(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let s, n = 0;
    for (const r of e) n === t.length ? t.push(s = new be(this.O(se()), this.O(se()), this, this.options)) : s = t[n], s._$AI(r), n++;
...
const Ye = class Ye {
  ...
  _$AI(e, t = this, s, n) {
    ...
    let a = !1;
    if (r === void 0) e = z(this, e, t, 0), a = !ie(e) || e !== this._$AH && e !== V, a && (this._$AH = e);
    else {
      const h = e;
      let d, f;
      for (e = r[0], d = 0; d < r.length - 1; d++) f = z(this, h[s + d], t, d), f === V && (f = this._$AH[d]), a ||= !ie(f) || f !== this._$AH[d], f === _ ? e = _ : e !== _ && (e += (f ?? "") + r[d + 1]), this._$AH[d] = f;
    }
    a && !n && this.j(e);
  }
  j(e) {
...
o(Qe, "W");
let He = Qe;
const ws = { I: G }, ms = $e.litHtmlPolyfillSupport;
ms?.(ne, G), ($e.litHtmlVersions ??= []).push("3.3.2");
const _s = /* @__PURE__ */ o((i, e, t) => {
  const s = t?.renderBefore ?? e;
  let n = s._$litPart$;
  if (n === void 0) {
    const r = t?.renderBefore ?? null;
    s._$litPart$ = n = new G(e.insertBefore(se(), r), r, void 0, t ?? {});
  }
  return n._$AI(i), n;
}, "B");
const Be = globalThis, et = class et extends N {
  constructor() {
...
o(et, "i");
let x = et;
x._$litElement$ = !0, x.finalized = !0, Be.litElementHydrateSupport?.({ LitElement: x });
const bs = Be.litElementPolyfillSupport;
bs?.({ LitElement: x });
