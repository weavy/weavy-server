...
const nt = /* @__PURE__ */ o((i) => typeof i == "boolean" ? i : i?.capture ?? !1, "isCaptureEventListener"), fe = 0, Te = 1, ue = 2, Me = 3, ze = class ze {
  ...
  dispatchEvent(e) {
    ...
    const Qe = /* @__PURE__ */ o((g) => {
      for (d = this; d.__host && g.includes(d.__host); )
        d = d.__host;
    }, "retarget");
    for (const g of w) {
      !h && (!d || d === g.__host) && Qe(w.slice(w.indexOf(g))), f = g, a = g === e.target ? ue : Te;
    ...
    d = null;
    for (const g of _e) {
      !h && (!d || g === d.__host) && Qe(_e.slice(0, _e.indexOf(g) + 1)), f = g, a = g === e.target ? ue : Me;
...
let Re = Fe;
const Yt = Re, Qt = new Yt();
const Y = globalThis, Ie = Y.ShadowRoot && (Y.ShadyCSS === void 0 || Y.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, De = Symbol(), at = /* @__PURE__ */ new WeakMap();
var j;
let yt = (j = class {
  constructor(e, t, s) {
...
const es = /* @__PURE__ */ o((i) => new yt(typeof i == "string" ? i : i + "", void 0, De), "r$2"), vs = /* @__PURE__ */ o((i, ...e) => {
  ...
  if (Ie) i.adoptedStyleSheets = e.map(((t) => t instanceof CSSStyleSheet ? t : t.styleSheet));
    ...
    const s = document.createElement("style"), n = Y.litNonce;
    n !== void 0 && s.setAttribute("nonce", n), s.textContent = t.cssText, i.appendChild(s);
  }
}, "S$1"), ot = Ie || Y.CSSStyleSheet === void 0 ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
...
ie.customElements ??= Qt;
const dt = ie.trustedTypes, ds = dt ? dt.emptyScript : "", ls = ie.reactiveElementPolyfillSupport, Q = /* @__PURE__ */ o((i, e) => i, "f$1"), ke = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? ds : null;
      break;
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[Q("elementProperties")] = /* @__PURE__ */ new Map(), x[Q("finalized")] = /* @__PURE__ */ new Map(), ls?.({ ReactiveElement: x }), (ie.reactiveElementVersions ??= []).push("2.1.1");
...
const We = globalThis, Ye = class Ye extends x {
  constructor() {
