...
var o = [
  ...
  "null"
  // Rest of ConstValue
], p = a(u), b = ["callback", "dictionary", "enum", "interface"], v = a(b), A = ["typedef"], g = a(A), h = /^[:<=>?]/, D = /^-?([1-9][0-9]*|0[Xx][0-9A-Fa-f]+|0[0-7]*)/, E = /^-?(([0-9]+\.[0-9]*|[0-9]*\.[0-9]+)([Ee][+-]?[0-9]+)?|[0-9]+[Ee][+-]?[0-9]+)/, l = /^_?[A-Za-z][0-9A-Z_a-z-]*/, k = /^_?[A-Za-z][0-9A-Z_a-z-]*(?=\s*;)/, C = /^"[^"]*"/, w = /^\/\*.*?\*\//, O = /^\/\*.*/, S = /^.*?\*\//;
function N(e, r) {
