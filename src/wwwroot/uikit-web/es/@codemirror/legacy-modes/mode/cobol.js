...
var L = (E, T) => e(E, "name", { value: T, configurable: !0 });
var G = "builtin", n = "comment", D = "string", S = "atom", i = "number", B = "keyword", t = "header", F = "def", Y = "link";
function C(E) {
  for (var T = {}, I = E.split(" "), R = 0; R < I.length; ++R) T[I[R]] = !0;
  return T;
}
L(C, "makeKeywords");
var U = C("TRUE FALSE ZEROES ZEROS ZERO SPACES SPACE LOW-VALUE LOW-VALUES "), P = C(
        ...
        if (A >= 0 && A <= 5)
          ...
          if (E.current().match(N.symbol))
            for (; A < 71 && E.eat(N.symbol) !== void 0; )
              A++;
          P && P.propertyIsEnumerable(E.current().toUpperCase()) ? I = B : M && M.propertyIsEnumerable(E.current().toUpperCase()) ? I = G : U && U.propertyIsEnumerable(E.current().toUpperCase()) ? I = S : I = null;
        }
    }
    return I;
  }, "token"),
  indent: /* @__PURE__ */ L(function(E) {
