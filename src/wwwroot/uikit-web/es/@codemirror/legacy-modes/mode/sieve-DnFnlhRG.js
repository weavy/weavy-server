...
t(f, "words");
var c = f("if elsif else stop require"), d = f("true false not");
function u(n, e) {
  var i = n.next();
  if (i == "/" && n.eat("*"))
  ...
  n.eatWhile(/\w/);
  var r = n.current();
  return r == "text" && n.eat(":") ? (e.tokenize = k, "string") : c.propertyIsEnumerable(r) ? "keyword" : d.propertyIsEnumerable(r) ? "atom" : null;
}
t(u, "tokenBase");
function k(n, e) {
