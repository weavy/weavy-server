...
function p(e, n) {
  ...
  return t == "}" ? (n.tokenize = c, "tag") : t == "(" || t == ")" ? "bracket" : t == "=" ? (d = "equals", r == ">" && (e.next(), r = e.peek()), /[\'\"]/.test(r) || (n.tokenize = L()), "operator") : /[\'\"]/.test(t) ? (n.tokenize = O(t), n.tokenize(e, n)) : (e.eatWhile(/[^\s\u00a0=\"\'\/?]/), "keyword");
}
i(p, "inPlugin");
function O(e) {
  return function(n, t) {
...
function N(e) {
  if (e == "openPlugin")
    return u.pluginName = g, o(h, P(u.startOfLine));
  if (e == "closePlugin") {
    var n = !1;
    return u.context ? (n = u.context.pluginName != g, b()) : n = !0, n && (a = "error"), o(S(n));
...
i(S, "endcloseplugin");
function h(e) {
  return e == "keyword" ? (a = "attribute", o(h)) : e == "equals" ? o(_, h) : s();
}
i(h, "attributes");
function _(e) {
