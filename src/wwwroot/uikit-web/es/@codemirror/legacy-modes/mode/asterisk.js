...
var c = ["exten", "same", "include", "ignorepat", "switch"], l = ["#include", "#exec"], s = [
  "addqueuemember",
  "adsiprog",
  "aelsub",
  "agentlogin",
...
function u(e, n) {
  ...
  if (a == "#" && (e.eatWhile(/\w/), i = e.current(), l.indexOf(i) !== -1))
  ...
  if (e.eatWhile(/\w/), i = e.current(), c.indexOf(i) !== -1) {
...
const p = {
  ...
  token: /* @__PURE__ */ r(function(e, n) {
    ...
    if (n.extenApplication) {
      ...
      if (e.eatWhile(/\w/), i = e.current().toLowerCase(), n.extenApplication = !1, s.indexOf(i) !== -1)
        return "def";
    } else
      return u(e, n);
    return null;
