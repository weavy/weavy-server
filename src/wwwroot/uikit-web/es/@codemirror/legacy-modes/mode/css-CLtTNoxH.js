...
function v(i) {
  i = { ...se, ...i };
  var l = i.inline, f = i.tokenHooks, k = i.documentTypes || {}, R = i.mediaTypes || {}, I = i.mediaFeatures || {}, G = i.mediaValueKeywords || {}, S = i.propertyKeywords || {}, A = i.nonStandardPropertyKeywords || {}, J = i.fontProperties || {}, Q = i.counterDescriptors || {}, O = i.colorKeywords || {}, F = i.valueKeywords || {}, b = i.allowNested, ee = i.lineComment, re = i.supportsAtComponent === !0, N = i.highlightNonStandardPropertyKeywords !== !1, y, n;
  function c(e, o) {
    return y = o, e;
  }
  a(c, "ret");
  ...
  return s.top = function(e, o, r) {
    ...
    if (e == "word") {
      var t = o.current().toLowerCase();
      t == "only" || t == "not" || t == "and" || t == "or" ? n = "keyword" : R.hasOwnProperty(t) ? n = "attribute" : I.hasOwnProperty(t) ? n = "property" : G.hasOwnProperty(t) ? n = "keyword" : S.hasOwnProperty(t) ? n = "property" : A.hasOwnProperty(t) ? n = N ? "string.special" : "property" : F.hasOwnProperty(t) ? n = "atom" : O.hasOwnProperty(t) ? n = "keyword" : n = "error";
    }
    return r.context.type;
    ...
    return e == "}" ? (r.stateArg = null, p(r)) : e == "word" ? (r.stateArg == "@font-face" && !J.hasOwnProperty(o.current().toLowerCase()) || r.stateArg == "@counter-style" && !Q.hasOwnProperty(o.current().toLowerCase()) ? n = "error" : n = "property", "maybeprop") : "restricted_atBlock";
...
var D = [
  ...
  "xx-large",
  "xx-small"
], q = m(M), le = D.concat(H).concat(E).concat(Y).concat(C).concat(X).concat(Z).concat(M);
const se = {
  documentTypes: L,
  mediaTypes: x,
  mediaFeatures: z,
