...
const ke = {
  ...
  indent: /* @__PURE__ */ a(function(i, e, r) {
    ...
    return o.prev && (c == "}" && (o.type == "block" || o.type == "atBlock" || o.type == "keyframes") || c == ")" && (o.type == "parens" || o.type == "atBlock_parens") || c == "{" && o.type == "at") ? p = o.indent - r.unit : /(\})/.test(c) || (/@|\$|\d/.test(c) || /^\{/.test(e) || /^\s*\/(\/|\*)/.test(e) || /^\s*\/\*/.test(s) || /^\s*[\w-\.\[\]\'\"]+\s*(\?|:|\+)?=/i.test(e) || /^(\+|-)?[a-z][\w-]*\(/i.test(e) || /^return/.test(e) || v(q) ? p = g : /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(c) || m(q) ? /\,\s*$/.test(s) ? p = u : /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(s) || m(s) ? p = g <= u ? u : u + r.unit : p = g : !/,\s*$/.test(e) && (B(q) || y(q)) && (v(s) ? p = g <= u ? u : u + r.unit : /^\{/.test(s) ? p = g <= u ? g : u + r.unit : B(s) || y(s) ? p = g >= u ? u : g : /^(\.|#|:|\[|\*|&|@|\+|\-|>|~|\/)/.test(s) || /=\s*$/.test(s) || m(s) || /^\$[\w-\.\[\]\'\"]/.test(s) ? p = u + r.unit : p = g)), p;
  }, "indent"),
  languageData: {
    indentOnInput: /^\s*\}$/,
