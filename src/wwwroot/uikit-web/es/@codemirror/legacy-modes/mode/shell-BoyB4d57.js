...
function w(n, e) {
  ...
  if (t === "\\")
    return n.next(), null;
  if (t === "'" || t === '"' || t === "`")
    return e.tokens.unshift(l(t, t === "`" ? "quote" : "string")), c(n, e);
  if (t === "#")
    return i && n.eat("!") ? (n.skipToEnd(), "meta") : (n.skipToEnd(), "comment");
  if (t === "$")
    return e.tokens.unshift(d), c(n, e);
  if (t === "+" || t === "=")
    return "operator";
  if (t === "-")
  ...
  return function(t, f) {
    for (var r, u = !1; (r = t.next()) != null; ) {
      if (r === i && !u) {
        ...
        if (!u && n !== i && r === n)
          return f.tokens.unshift(l(n, e)), c(t, f);
        if (!u && /['"]/.test(r) && !/['"]/.test(n)) {
...
function v(n, e) {
  return function(i, t) {
    return t.tokens[0] = l(n, e), i.next(), c(i, t);
  };
}
...
var d = /* @__PURE__ */ o(function(n, e) {
  ...
  var i = n.next();
  return /['"({]/.test(i) ? (e.tokens[0] = l(i, i == "(" ? "quote" : i == "{" ? "def" : "string"), c(n, e)) : (/\d/.test(i) || n.eatWhile(/\w/), e.tokens.shift(), "def");
}, "tokenDollar");
function b(n) {
  return function(e, i) {
