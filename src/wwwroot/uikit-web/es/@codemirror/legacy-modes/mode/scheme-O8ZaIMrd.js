...
t(N, "stateStack");
function u(e, n, i) {
  e.indentStack = new N(n, i, e.indentStack);
}
t(u, "pushStack");
function Q(e) {
...
t(Q, "popStack");
var R = new RegExp(/^(?:[-+]i|[-+][01]+#*(?:\/[01]+#*)?i|[-+]?[01]+#*(?:\/[01]+#*)?@[-+]?[01]+#*(?:\/[01]+#*)?|[-+]?[01]+#*(?:\/[01]+#*)?[-+](?:[01]+#*(?:\/[01]+#*)?)?i|[-+]?[01]+#*(?:\/[01]+#*)?)(?=[()\s;"]|$)/i), I = new RegExp(/^(?:[-+]i|[-+][0-7]+#*(?:\/[0-7]+#*)?i|[-+]?[0-7]+#*(?:\/[0-7]+#*)?@[-+]?[0-7]+#*(?:\/[0-7]+#*)?|[-+]?[0-7]+#*(?:\/[0-7]+#*)?[-+](?:[0-7]+#*(?:\/[0-7]+#*)?)?i|[-+]?[0-7]+#*(?:\/[0-7]+#*)?)(?=[()\s;"]|$)/i), O = new RegExp(/^(?:[-+]i|[-+][\da-f]+#*(?:\/[\da-f]+#*)?i|[-+]?[\da-f]+#*(?:\/[\da-f]+#*)?@[-+]?[\da-f]+#*(?:\/[\da-f]+#*)?|[-+]?[\da-f]+#*(?:\/[\da-f]+#*)?[-+](?:[\da-f]+#*(?:\/[\da-f]+#*)?)?i|[-+]?[\da-f]+#*(?:\/[\da-f]+#*)?)(?=[()\s;"]|$)/i), B = new RegExp(/^(?:[-+]i|[-+](?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*)i|[-+]?(?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*)@[-+]?(?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*)|[-+]?(?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*)[-+](?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*)?i|(?:(?:(?:\d+#+\.?#*|\d+\.\d*#*|\.\d+#*|\d+)(?:[esfdl][-+]?\d+)?)|\d+#*\/\d+#*))(?=[()\s;"]|$)/i);
function U(e) {
  return e.match(R);
}
t(U, "isBinaryNumber");
...
t(_, "isOctalNumber");
function p(e, n) {
  return n === !0 && e.backUp(1), e.match(B);
}
t(p, "isDecimalNumber");
function $(e) {
  return e.match(O);
      ...
      default:
        ...
        if (r == '"')
          ...
          if (e.eat("|"))
            ...
            var a = null, d = !1, h = !0;
            e.eat(/[ei]/i) ? d = !0 : e.backUp(1), e.match(/^#b/i) ? a = U : e.match(/^#o/i) ? a = _ : e.match(/^#x/i) ? a = $ : e.match(/^#d/i) ? a = p : e.match(/^[-+0-9.]/, !1) ? (h = !1, a = p) : d || e.eat("#"), a != null && (h && !d && e.match(/^#[ei]/i), a(e) && (i = v));
          }
          ...
          for (var s = "", f = e.column(), g; (g = e.eat(/[^\s\(\[\;\)\]]/)) != null; )
            s += g;
          s.length > 0 && M.propertyIsEnumerable(s) ? u(n, f + C, r) : (e.eatSpace(), e.eol() || e.peek() == ";" ? u(n, f + 1, r) : u(n, f + e.current().length, r)), e.backUp(e.current().length - 1), typeof n.sExprComment == "number" && n.sExprComment++, typeof n.sExprQuote == "number" && n.sExprQuote++, i = k;
