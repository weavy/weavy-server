...
r(o, "wordRegexp");
var a = new RegExp("^[\\+\\-\\*/&|\\^~<>!@'\\\\]"), c = new RegExp("^[\\(\\[\\{\\},:=;\\.]"), l = new RegExp("^((==)|(~=)|(<=)|(>=)|(<<)|(>>)|(\\.[\\+\\-\\*/\\^\\\\]))"), p = new RegExp("^((!=)|(\\+=)|(\\-=)|(\\*=)|(/=)|(&=)|(\\|=)|(\\^=))"), d = new RegExp("^((>>=)|(<<=))"), s = new RegExp("^[\\]\\)]"), m = new RegExp("^[_A-Za-z¡-￿][_A-Za-z0-9¡-￿]*"), h = o([
  "error",
  "eval",
  "function",
  "abs",
...
function t(e, n) {
  ...
  return i ? i[1] ? "string" : "error" : e.match(g) ? "keyword" : e.match(h) ? "builtin" : e.match(m) ? "variable" : e.match(a) || e.match(l) ? "operator" : e.match(c) || e.match(p) || e.match(d) ? null : e.match(s) ? (n.tokenize = f, null) : (e.next(), "error");
}
r(t, "tokenBase");
const v = {
  name: "octave",
