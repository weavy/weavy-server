...
var a = (i, o) => Y(i, "name", { value: o, configurable: !0 });
function q(i) {
  ...
  ), b = /[\+\-\*\/!~&|^%=?:]/, y = /[\[\]{}()]/, _ = /\d[0-9_]*/, C = /\d*\s*'s?d\s*\d[0-9_]*/i, T = /\d*\s*'s?b\s*[xz01][xz01_]*/i, W = /\d*\s*'s?o\s*[xz0-7][xz0-7_]*/i, M = /\d*\s*'s?h\s*[0-9a-fxz?][0-9a-fxz?_]*/i, L = /(\d[\d_]*(\.\d[\d_]*)?E-?[\d_]+)|(\d[\d_]*\.\d[\d_]*)/i, U = /^((\w+)|[)}\]])/, K = /[)}\]]/, s, p, R = h(
  ...
  function x(e, n) {
    ...
    if (t == '"')
      return e.next(), n.tokenize = F(t), n.tokenize(e, n);
    if (t == "/") {
      if (e.next(), e.eat("*"))
    ...
    if (e.eatWhile(/[\w\$_]/)) {
      var l = e.current();
      return m[l] ? (d[l] && (s = "newblock"), D[l] && (s = "newstatement"), p = l, "keyword") : "variable";
    }
    return e.next(), null;
  }
  a(x, "tokenBase");
  ...
  a(E, "Context");
  function g(e, n, t) {
    var r = e.indented, l = new E(r, n, t, null, e.context);
    return e.context = l;
  }
  a(g, "pushContext");
  function z(e) {
  ...
  return a(P, "buildElectricInputRegEx"), {
    name: "verilog",
    startState: /* @__PURE__ */ a(function(e) {
      var n = {
        tokenize: null,
        context: new E(-e, 0, "top", !1),
        indented: 0,
        startOfLine: !0
      };
    ...
    token: /* @__PURE__ */ a(function(e, n) {
      ...
      if (t.align == null && (t.align = !0), s == t.type)
        z(n);
      else if (s == ";" && t.type == "statement" || t.type && N(p, t.type))
    ...
    indent: /* @__PURE__ */ a(function(e, n, t) {
      ...
      var I = !1, $ = n.match(U);
      return $ && (I = N($[0], l.type)), l.type == "statement" ? l.indented + (w == "{" ? 0 : o || t.unit) : K.test(l.type) && l.align && !f ? l.column + (I ? 0 : 1) : l.type == ")" && !I ? l.indented + (o || t.unit) : l.indented + (I ? 0 : t.unit);
    }, "indent"),
    languageData: {
      indentOnInput: P(),
  ...
  hooks: {
    ...
    token: /* @__PURE__ */ a(function(i, o) {
      ...
      if (i.sol() && !o.tlvInBlockComment) {
        i.peek() == "\\" && (f = "def", i.skipToEnd(), i.string.match(/\\SV/) ? o.tlvCodeActive = !1 : i.string.match(/\\TLV/) && (o.tlvCodeActive = !0)), o.tlvCodeActive && i.pos == 0 && o.indented == 0 && (u = i.match(G, !1)) && (o.indented = u[0].length);
        var v = o.indented, c = v / B;
        if (c <= o.tlvIndentationStyle.length) {
          var h = i.string.length == v, m = c * B;
          if (m < i.string.length) {
            var b = i.string.slice(m), y = b[0];
            A[y] && (u = b.match(O)) && S[u[1]] && (v += B, y == "\\" && m > 0 || (o.tlvIndentationStyle[c] = A[y], c++));
          }
          if (!h)
      ...
      if (o.tlvCodeActive) {
        ...
        else if ((u = i.match(J)) && !o.tlvInBlockComment)
