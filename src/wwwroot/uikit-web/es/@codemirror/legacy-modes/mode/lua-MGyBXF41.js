...
var f = l([
  ...
  "in",
  "local"
]), m = l(["function", "if", "repeat", "do", "\\(", "{"]), p = l(["end", "until", "\\)", "}"]), b = g(["end", "until", "\\)", "}", "else", "elseif"]);
function s(e) {
  for (var t = 0; e.eat("="); ) ++t;
  return e.eat("["), t;
}
...
const w = {
  ...
  token: /* @__PURE__ */ a(function(e, t) {
    ...
    return n == "variable" && (h.test(i) ? n = "keyword" : f.test(i) && (n = "builtin")), n != "comment" && n != "string" && (m.test(i) ? ++t.indentDepth : p.test(i) && --t.indentDepth), n;
  }, "token"),
