...
const P = {
  ...
  token: /* @__PURE__ */ r(function(e, I) {
    ...
    if (R == "_") {
      ...
      return e.eatWhile(function(n) {
        return n != " " ? (E += n, !0) : !1;
      }), I.bnodes.push(E), e.next(), T(I, " "), "builtin";
    }
    if (R == '"')
    ...
    if (R == "@") {
      ...
      return e.eatWhile(function(n) {
        return n != " " ? (l += n, !0) : !1;
      }), I.langs.push(l), e.next(), T(I, " "), "string.special";
    }
    if (R == "^") {
      e.next(), T(I, "^");
      var u = "";
      return e.eatWhile(function(n) {
        return n != ">" ? (u += n, !0) : !1;
      }), I.types.push(u), e.next(), T(I, ">"), "variable";
    }
    R == " " && T(I, R), R == "." && T(I, R);
  }, "token")
};
