...
var o = (e, n) => E(e, "name", { value: n, configurable: !0 });
var T = [
  "-type",
  "-spec",
  "-export_type",
  ...
  "unregister",
  "whereis"
], d = /[\w@Ø-ÞÀ-Öß-öø-ÿ]/, j = /[0-7]{1,3}|[bdefnrstv\\"']|\^[a-zA-Z]|x[0-9a-zA-Z]{2}|x{[0-9a-zA-Z]+}/;
function Q(e, n) {
  if (n.in_string)
  ...
  if (!p(n) && e.match(/-\s*[a-zß-öø-ÿ][\wØ-ÞÀ-Öß-öø-ÿ]*/))
    return l(e.current(), T) ? t(n, e, "type") : t(n, e, "attribute");
  var r = e.next();
  if (r == "%")
  ...
  if (r == "$")
    return e.next() == "\\" && !e.match(j) ? t(n, e, "error") : t(n, e, "number");
  if (r == ".")
    return t(n, e, "dot");
  if (r == "'") {
    if (!(n.in_atom = !y(e))) {
  ...
  if (/[a-z_ß-öø-ÿ]/.test(r)) {
    if (e.eatWhile(d), e.match(/\s*\/\s*[0-9]/, !1))
      return e.match(/\s*\/\s*[0-9]/, !0), t(n, e, "fun");
    var i = e.current();
    return l(i, x) ? t(n, e, "keyword") : l(i, A) ? t(n, e, "operator") : e.match(/\s*\(/, !1) ? l(i, O) && (p(n).token != ":" || p(n, 2).token == "erlang") ? t(n, e, "builtin") : l(i, q) ? t(n, e, "guard") : t(n, e, "function") : C(e) == ":" ? i == "erlang" ? t(n, e, "builtin") : t(n, e, "function") : l(i, ["true", "false"]) ? t(n, e, "boolean") : t(n, e, "atom");
  }
  var c = /[0-9]/, u = /[0-9a-zA-Z]/;
  return c.test(r) ? (e.eatWhile(c), e.eat("#") ? e.eatWhile(u) || e.backUp(1) : e.eat(".") && (e.eatWhile(c) ? e.eat(/[eE]/) && (e.eat(/[-+]/) ? e.eatWhile(c) || e.backUp(2) : e.eatWhile(c) || e.backUp(1)) : e.backUp(1)), t(n, e, "number")) : k(e, Z, g) ? t(n, e, "open_paren") : k(e, P, w) ? t(n, e, "close_paren") : v(e, z, R) ? t(n, e, "separator") : v(e, U, m) ? t(n, e, "operator") : t(n, e, null);
}
o(Q, "tokenizer");
function k(e, n, r) {
...
o(p, "peekToken");
function I(e, n) {
  n.type == "comment" || n.type == "whitespace" || (e.tokenStack = M(e.tokenStack, n), e.tokenStack = N(e.tokenStack));
}
o(I, "pushToken");
function M(e, n) {
  var r = e.length - 1;
...
o(f, "d");
function V(e, n, r) {
  var i, c = Y(n), u = p(e, 1), a = p(e, 2);
  return e.in_string || e.in_atom ? null : a ? u.token == "when" ? u.column + r.unit : c === "when" && a.type === "function" ? a.indent + r.unit : c === "(" && u.token === "fun" ? u.column + 3 : c === "catch" && (i = b(e, ["try"])) ? i.column : l(c, ["end", "after", "of"]) ? (i = b(e, ["begin", "case", "fun", "if", "receive", "try"]), i ? i.column : null) : l(c, w) ? (i = b(e, g), i ? i.column : null) : l(u.token, [",", "|", "||"]) || l(c, [",", "|", "||"]) ? (i = $(e), i ? i.column + i.token.length : r.unit) : u.token == "->" ? l(a.token, ["receive", "case", "if", "try"]) ? a.column + r.unit + r.unit : a.column + r.unit : l(u.token, g) ? u.column + u.token.length : (i = B(e), _(i) ? i.column + r.unit : 0) : 0;
}
o(V, "indenter");
function Y(e) {
  var n = e.match(/,|[a-z]+|\}|\]|\)|>>|\|+|\(/);
