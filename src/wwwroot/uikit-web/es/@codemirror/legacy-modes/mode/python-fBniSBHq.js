...
var t = (r, p) => N(r, "name", { value: p, configurable: !0 });
function x(r) {
...
t(f, "top");
function O(r) {
  for (var p = "error", R = r.delimiters || r.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/, g = [
    r.singleOperators,
    r.doubleOperators,
    r.doubleDelimiters,
    r.tripleDelimiters,
  ...
  function S(n, e) {
    ...
    if (o && (e.indent = n.indentation()), o && f(e).type == "py") {
      ...
      if (n.eatSpace()) {
        var l = n.indentation();
        return l > i ? _(n, e) : l < i && E(n, e) && n.peek() != "#" && (e.errorToken = !0), null;
      } else {
        var c = s(n, e);
        return i > 0 && E(n, e) && (c += " " + p), c;
      }
    }
    return s(n, e);
  }
  ...
  function s(n, e, o) {
    ...
    if (n.match(z)) {
      ...
      return c ? (e.tokenize = L(n.current(), e.tokenize), e.tokenize(n, e)) : (e.tokenize = B(n.current(), e.tokenize), e.tokenize(n, e));
    }
    for (var u = 0; u < g.length; u++)
      if (n.match(g[u])) return "operator";
    return n.match(R) ? "punctuation" : e.lastToken == "." && n.match(b) ? "property" : n.match(m) || n.match(Z) ? "keyword" : n.match(I) ? "builtin" : n.match(/^(self|cls)\b/) ? "self" : n.match(b) ? e.lastToken == "def" || e.lastToken == "class" ? "def" : "variable" : (n.next(), o ? null : p);
  }
  t(s, "tokenBaseInner");
  function L(n, e) {
    ...
    function l(u) {
      return function(d, k) {
        var T = s(d, k, !0);
        return T == "punctuation" && (d.current() == "{" ? k.tokenize = l(u + 1) : d.current() == "}" && (u > 1 ? k.tokenize = l(u - 1) : k.tokenize = c)), T;
      };
    }
    t(l, "tokenNestedExpr");
    function c(u, d) {
  ...
  function D(n, e) {
    ...
    if (/\S/.test(i) && (e.beginningOfLine = !1), (o == "variable" || o == "builtin") && e.lastToken == "meta" && (o = "meta"), (i == "pass" || i == "return") && (e.dedent = !0), i == "lambda" && (e.lambda = !0), i == ":" && !e.lambda && f(e).type == "py" && n.match(/^\s*(?:#|$)/, !1) && _(n, e), i.length == 1 && !/string|comment/.test(o)) {
      var l = "[({".indexOf(i);
      if (l != -1 && U(n, e, "])}".slice(l, l + 1)), l = "])}".indexOf(i), l != -1)
