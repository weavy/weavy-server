...
var y = /* @__PURE__ */ a(function(e, n) {
  ...
  return e.next(), "error";
}, "tokenBase"), k = "(?![\\d\\s])[$\\w\\xAA-\\uFFDC](?:(?!\\s)[$\\w\\xAA-\\uFFDC]|-[A-Za-z])*", p = RegExp("(?:[({[=:]|[-~]>|\\b(?:e(?:lse|xport)|d(?:o|efault)|t(?:ry|hen)|finally|import(?:\\s*all)?|const|var|let|new|catch(?:\\s*" + k + ")?))\\s*$"), r = "(?![$\\w]|-[A-Za-z]|\\s*:(?![:=]))", o = {
  token: "string",
  regex: ".+"
}, x = {
  start: [
