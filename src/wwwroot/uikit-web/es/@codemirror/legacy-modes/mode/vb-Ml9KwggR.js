...
o(c, "wordRegexp");
var m = new RegExp("^[\\+\\-\\*/%&\\\\|\\^~<>!]"), x = new RegExp("^[\\(\\)\\[\\]\\{\\}@,:`=;\\.]"), I = new RegExp("^((==)|(<>)|(<=)|(>=)|(<>)|(<<)|(>>)|(//)|(\\*\\*))"), R = new RegExp("^((\\+=)|(\\-=)|(\\*=)|(%=)|(/=)|(&=)|(\\|=)|(\\^=))"), O = new RegExp("^((//=)|(>>=)|(<<=)|(\\*\\*=))"), E = new RegExp("^[_A-Za-z][_A-Za-z0-9]*"), f = ["class", "module", "sub", "enum", "select", "while", "if", "function", "get", "set", "property", "try", "structure", "synclock", "using", "with"], h = ["else", "elseif", "case", "catch", "finally"], s = ["next", "loop"], v = ["and", "andalso", "or", "orelse", "xor", "in", "not", "is", "isnot", "like"], z = c(v), p = ["#const", "#else", "#elseif", "#end", "#if", "#region", "addhandler", "addressof", "alias", "as", "byref", "byval", "cbool", "cbyte", "cchar", "cdate", "cdbl", "cdec", "cint", "clng", "cobj", "compare", "const", "continue", "csbyte", "cshort", "csng", "cstr", "cuint", "culng", "cushort", "declare", "default", "delegate", "dim", "directcast", "each", "erase", "error", "event", "exit", "explicit", "false", "for", "friend", "gettype", "goto", "handles", "implements", "imports", "infer", "inherits", "interface", "isfalse", "istrue", "lib", "me", "mod", "mustinherit", "mustoverride", "my", "mybase", "myclass", "namespace", "narrowing", "new", "nothing", "notinheritable", "notoverridable", "of", "off", "on", "operator", "option", "optional", "out", "overloads", "overridable", "overrides", "paramarray", "partial", "private", "protected", "public", "raiseevent", "readonly", "redim", "removehandler", "resume", "return", "shadows", "shared", "static", "step", "stop", "strict", "then", "throw", "to", "true", "trycast", "typeof", "until", "until", "when", "widening", "withevents", "writeonly"], g = ["object", "boolean", "char", "string", "byte", "sbyte", "short", "ushort", "int16", "uint16", "integer", "uinteger", "int32", "uint32", "long", "ulong", "int64", "uint64", "decimal", "single", "double", "float", "date", "datetime", "intptr", "uintptr"], C = c(p), S = c(g), T = '"', _ = c(f), y = c(h), w = c(s), b = c(["end"]), A = c(["do"]);
function d(e, n) {
  n.currentIndent++;
}
o(d, "indent");
...
function a(e, n) {
  ...
  return e.match(T) ? (n.tokenize = F(e.current()), n.tokenize(e, n)) : e.match(O) || e.match(R) ? null : e.match(I) || e.match(m) || e.match(z) ? "operator" : e.match(x) ? null : e.match(A) ? (d(e, n), n.doInCurrentLine = !0, "keyword") : e.match(_) ? (n.doInCurrentLine ? n.doInCurrentLine = !1 : d(e, n), "keyword") : e.match(y) ? "keyword" : e.match(b) ? (u(e, n), u(e, n), "keyword") : e.match(w) ? (u(e, n), "keyword") : e.match(S) || e.match(C) ? "keyword" : e.match(E) ? "variable" : (e.next(), l);
}
o(a, "tokenBase");
function F(e) {
