...
u(f, "words");
var p = f("Assert BackQuote D Defun Deriv For ForEach FromFile FromString Function Integrate InverseTaylor Limit LocalSymbols Macro MacroRule MacroRulePattern NIntegrate Rule RulePattern Subst TD TExplicitSum TSum Taylor Taylor1 Taylor2 Taylor3 ToFile ToStdout ToString TraceRule Until While"), d = "(?:(?:\\.\\d+|\\d+\\.\\d*|\\d+)(?:[eE][+-]?\\d+)?)", l = "(?:[a-zA-Z\\$'][a-zA-Z0-9\\$']*)", s = new RegExp(d), k = new RegExp(l), v = new RegExp(l + "?_" + l), h = new RegExp(l + "\\s*\\(");
function c(e, n) {
  var r;
  if (r = e.next(), r === '"')
  ...
  if (i === "bodied" && r === "[" && n.scopes.pop(), (r === "[" || r === "{" || r === "(") && n.scopes.push(r), i = t(n), (i === "[" && r === "]" || i === "{" && r === "}" || i === "(" && r === ")") && n.scopes.pop(), r === ";")
    for (; i === "bodied"; )
      n.scopes.pop(), i = t(n);
  return e.match(/\d+ *#/, !0, !1) ? "qualifier" : e.match(s, !0, !1) ? "number" : e.match(v, !0, !1) ? "variableName.special" : e.match(/(?:\[|\]|{|}|\(|\))/, !0, !1) ? "bracket" : e.match(h, !0, !1) ? (e.backUp(1), "variableName.function") : e.match(k, !0, !1) ? "variable" : e.match(/(?:\\|\+|\-|\*|\/|,|;|\.|:|@|~|=|>|<|&|\||_|`|'|\^|\?|!|%|#)/, !0, !1) ? "operator" : "error";
}
u(c, "tokenBase");
function b(e, n) {
