...
c(d, "wordRegexp");
var w = /^(?:->|=>|\+[+=]?|-[\-=]?|\*[\*=]?|\/[\/=]?|[=!]=|<[><]?=?|>>?=?|%=?|&=?|\|=?|\^=?|\~|!|\?|(or|and|\|\||&&|\?)=)/, a = /^(?:[()\[\]{},:`=;]|\.\.?\.?)/, t = /^[_A-Za-z$][_A-Za-z$0-9]*/, z = /^@[_A-Za-z$][_A-Za-z$0-9]*/, x = d([
  "and",
  "or",
  "not",
  "is",
...
p = d(p);
var O = /^('{3}|\"{3}|['\"])/, R = /^(\/{3}|\/)/, S = ["Infinity", "NaN", "undefined", "null", "true", "false", "on", "off", "yes", "no"], E = d(S);
function l(e, n) {
  if (e.sol()) {
  ...
  if (e.match("###"))
    return n.tokenize = _, n.tokenize(e, n);
  if (r === "#")
    return e.skipToEnd(), "comment";
  if (e.match(/^-?[0-9\.]/, !1)) {
    var u = !1;
  ...
  return e.match(w) || e.match(x) ? "operator" : e.match(a) ? "punctuation" : e.match(E) ? "atom" : e.match(z) || n.prop && e.match(t) ? "property" : e.match(A) ? "keyword" : e.match(t) ? "variable" : (e.next(), g);
}
c(l, "tokenBase");
function k(e, n, i) {
  return function(f, r) {
