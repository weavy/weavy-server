...
var y = [];
function f(e) {
  if (e) for (var t in e) e.hasOwnProperty(t) && y.push(t);
}
s(f, "add");
f(i.keywords);
f(i.builtin);
f(i.timerOps);
f(i.portOps);
var x = i.keywords || {}, g = i.builtin || {}, k = i.timerOps || {}, O = i.portOps || {}, w = i.configOps || {}, E = i.verdictOps || {}, C = i.sutOps || {}, I = i.functionOps || {}, z = i.verdictConsts || {}, L = i.booleanConsts || {}, M = i.otherConsts || {}, S = i.types || {}, W = i.visibilityModifiers || {}, T = i.templateMatch || {}, _ = i.indentStatements !== !1, m = /[+\-*&@=<>!\/]/, l;
function A(e, t) {
  var n = e.next();
  if (n == '"' || n == "'")
...
const R = {
  ...
  token: /* @__PURE__ */ s(function(e, t) {
    ...
    } else l == n.type ? a(t) : _ && ((n.type == "}" || n.type == "top") && l != ";" || n.type == "statement" && l == "newstatement") && p(t, e.column(), "statement");
