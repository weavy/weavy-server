...
var a = /^-+$/, i = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)  ?\d{1,2} \d{2}:\d{2}(:\d{2})? [A-Z]{3,4} \d{4} - /, t = /^[\w+.-]+@[\w.-]+/;
const m = {
  name: "rpmchanges",
  token: /* @__PURE__ */ n(function(r) {
    return r.sol() && (r.match(a) || r.match(i)) ? "tag" : r.match(t) ? "string" : (r.next(), null);
  }, "token")
};
