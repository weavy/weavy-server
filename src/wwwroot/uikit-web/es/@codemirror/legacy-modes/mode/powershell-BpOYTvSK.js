...
var i = (e, n) => P(e, "name", { value: n, configurable: !0 });
function u(e, n) {
  n = n || {};
...
var v = "(?=[^A-Za-z\\d\\-_]|$)", s = /[\w\-:]/, b = u([
  ...
  /[ic]?replace/,
  /b?(and|or|xor)/
], { prefix: "-" }), h = /[+\-*\/%]=|\+\+|--|\.\.|[+\-*&^%:=!|\/]|<(?!#)|(?!#)>/, x = u([k, h], { suffix: "" }), E = /^((0x[\da-f]+)|((\d+\.\d+|\d\.|\.\d+|\d+)(e[\+\-]?\d+)?))[ld]?([kmgtp]b)?/i, y = /^[A-Za-z\_][A-Za-z\-\_\d]*\b/, w = /[A-Z]:|%|\?/i, R = u([
  ...
  /true|false|null/
], { prefix: "\\$", suffix: "" }), I = u([w, R, M], { suffix: v }), S = {
  keyword: b,
  number: E,
  operator: x,
  builtin: I,
...
i(T, "tokenSingleQuoteString");
function d(e, n) {
  for (var r; (r = e.peek()) != null; ) {
    if (r === "$")
      return n.tokenize = z, "string";
    if (e.next(), r === "`") {
      e.next();
      continue;
    }
...
i(d, "tokenDoubleQuoteString");
function z(e, n) {
  return g(e, n, d);
}
i(z, "tokenStringInterpolation");
function D(e, n) {
...
i(O, "tokenHereStringInterpolation");
function g(e, n, r) {
  if (e.match("$(")) {
