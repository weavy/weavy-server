...
o(s, "metaHook");
var m = p("null"), d = { "`": s, $: s }, h = !1, v = p("abs,access,after,alias,all,and,architecture,array,assert,attribute,begin,block,body,buffer,bus,case,component,configuration,constant,disconnect,downto,else,elsif,end,end block,end case,end component,end for,end generate,end if,end loop,end process,end record,end units,entity,exit,file,for,function,generate,generic,generic map,group,guarded,if,impure,in,inertial,inout,is,label,library,linkage,literal,loop,map,mod,nand,new,next,nor,null,of,on,open,or,others,out,package,package body,port,port map,postponed,procedure,process,pure,range,record,register,reject,rem,report,return,rol,ror,select,severity,signal,sla,sll,sra,srl,subtype,then,to,transport,type,unaffected,units,until,use,variable,wait,when,while,with,xnor,xor"), b = p("architecture,entity,begin,case,port,else,elsif,end,for,function,if"), g = /[&|~><!\)\(*#%@+\/=?\:;}{,\.\^\-\[\]]/, l;
function f(e, n) {
  var t = e.next();
  if (d[t]) {
    var r = d[t](e, n);
  ...
  e.eatWhile(/[\w\$_]/);
  var i = e.current();
  return v.propertyIsEnumerable(i.toLowerCase()) ? (b.propertyIsEnumerable(i) && (l = "newstatement"), "keyword") : m.propertyIsEnumerable(i) ? "atom" : "variable";
}
o(f, "tokenBase");
function w(e) {
  return function(n, t) {
...
o(y, "Context");
function c(e, n, t) {
  return e.context = new y(e.indented, n, t, null, e.context);
}
o(c, "pushContext");
function a(e) {
