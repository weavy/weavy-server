...
const g = {
  ...
  token: /* @__PURE__ */ a(function(e, r) {
    ...
    if (n == "variable") {
      var t = e.current();
      n = s.propertyIsEnumerable(e.current()) ? "keyword" : f.propertyIsEnumerable(e.current()) ? "operator" : /^[A-Z][A-Z_0-9]*$/g.test(t) ? "tag" : /^0[bB][0-1]+$/g.test(t) || /^0[cC][0-7]+$/g.test(t) || /^0[xX][a-fA-F0-9]+$/g.test(t) || /^([0-9]+\.[0-9]*)|([0-9]*\.[0-9]+)$/g.test(t) || /^[0-9]+$/g.test(t) ? "number" : "variable";
    }
    return n;
  }, "token"),
  languageData: {
