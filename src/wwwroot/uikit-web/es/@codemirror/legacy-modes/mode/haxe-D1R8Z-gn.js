...
i(l, "kw");
var B = l("keyword a"), W = l("keyword b"), w = l("keyword c"), J = l("operator"), O = { type: "atom", style: "atom" }, A = { type: "attribute", style: "attribute" }, s = l("typedef"), I = {
  if: B,
  while: B,
  else: W,
  do: W,
...
function V(e, r) {
  ...
  if (r.reAllowed && n == "~" && e.eat(/\//))
    return L(e, "/"), e.eatWhile(/[gimsu]/), h("regexp", "string.special");
  if (n == "/")
    return e.eat("*") ? F(e, r, Q) : e.eat("/") ? (e.skipToEnd(), h("comment", "comment")) : (e.eatWhile(z), h("operator", null, e.current()));
  if (n == "#")
    return e.skipToEnd(), h("conditional", "meta");
  if (n == "@")
    return e.eat(/:/), e.eatWhile(/[\w_]/), h("metadata", "meta");
  if (z.test(n))
    return e.eatWhile(z), h("operator", null, e.current());
  var u;
  if (/[A-Z]/.test(n))
...
function K(e) {
  return function(r, n) {
    return L(r, e) && (n.tokenize = V), h("string", "string");
  };
}
i(K, "haxeTokenString");
function Q(e, r) {
...
i(Q, "haxeTokenComment");
var R = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0 };
function U(e, r, n, u, a, d) {
  ...
  for (f.state = e, f.stream = a, f.marked = null, f.cc = d, e.lexical.hasOwnProperty("align") || (e.lexical.align = !0); ; ) {
    ...
    if (g(n, u)) {
      for (; d.length && d[d.length - 1].lex; )
        d.pop()();
      return f.marked ? f.marked : n == "variable" && X(e, u) ? "variableName.local" : n == "variable" && re(e, u) ? "variableName.special" : r;
    }
  }
}
i(ee, "parseHaxe");
...
function T(e) {
  var r = f.state;
  if (r.context) {
    if (f.marked = "def", H(e, r.localVars)) return;
...
function c(e, r) {
  var n = /* @__PURE__ */ i(function() {
    var u = f.state;
    u.lexical = new U(u.indented, f.stream.column(), e, null, u.lexical, r);
  }, "result");
  return n.lex = !0, n;
}
i(c, "pushlex");
...
i(p, "expect");
function b(e) {
  return e == "@" ? t(D) : e == "var" ? t(c("vardef"), P, p(";"), o) : e == "keyword a" ? t(c("form"), v, b, o) : e == "keyword b" ? t(c("form"), b, o) : e == "{" ? t(c("}"), C, Z, o, S) : e == ";" ? t() : e == "attribute" ? t(j) : e == "function" ? t(y) : e == "for" ? t(
    c("form"),
    p("("),
    c(")"),
    oe,
    ...
    o,
    S
  ) : e == "import" ? t(M, p(";")) : e == "typedef" ? t(ie) : m(c("stat"), v, p(";"), o);
}
i(b, "statement");
function v(e) {
  return R.hasOwnProperty(e) || e == "type" ? t(x) : e == "function" ? t(y) : e == "keyword c" ? t(_) : e == "(" ? t(c(")"), _, p(")"), o, x) : e == "operator" ? t(v) : e == "[" ? t(c("]"), k(_, "]"), o, x) : e == "{" ? t(c("}"), k(fe, "}"), o, x) : t();
}
i(v, "expression");
function _(e) {
...
i(x, "maybeoperator");
function j(e) {
  if (e == "attribute") return t(j);
  if (e == "function") return t(y);
  if (e == "var") return t(P);
}
i(j, "maybeattribute");
function D(e) {
  if (e == ":" || e == "variable") return t(D);
...
function M(e, r) {
  if (e == "variable" && /[A-Z]/.test(r.charAt(0)))
    return $(r), t();
  if (e == "variable" || e == "property" || e == "." || r == "*") return t(M);
}
i(M, "importdef");
function ie(e, r) {
  if (e == "variable" && /[A-Z]/.test(r.charAt(0)))
...
i(ae, "property");
function fe(e) {
  if (e == "variable" && (f.marked = "property"), R.hasOwnProperty(e)) return t(p(":"), v);
}
i(fe, "objprop");
function k(e, r) {
  function n(u) {
...
const pe = {
  ...
  token: /* @__PURE__ */ i(function(e, r) {
    ...
    return s == "comment" ? n : (r.reAllowed = !!(s == "operator" || s == "keyword c" || s.match(/^[\[{}\(,;:]$/)), r.kwAllowed = s != ".", ee(r, n, s, N, e));
  }, "token"),
