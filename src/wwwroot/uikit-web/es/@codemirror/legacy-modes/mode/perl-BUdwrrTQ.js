...
var E = (n, e) => I(n, "name", { value: e, configurable: !0 });
function t(n, e) {
...
function r(n, e, u, $, R) {
  return e.chain = null, e.style = null, e.tail = null, e.tokenize = function(i, _) {
    for (var A = !1, d, g = 0; d = i.next(); ) {
      if (d === u[g] && !A)
        return u[++g] !== void 0 ? (_.chain = u[g], _.style = $, _.tail = R) : R && i.eatWhile(R), _.tokenize = T, $;
      A = !A && d == "\\";
    }
    return $;
  }, e.tokenize(n, e);
...
function O(n, e, u) {
  return e.tokenize = function($, R) {
    return $.string == u && (R.tokenize = T), $.skipToEnd(), "string";
  }, e.tokenize(n, e);
}
E(O, "tokenSOMETHING");
function T(n, e) {
  ...
  if (u == "/")
    return /~\s*$/.test(c(n)) ? r(n, e, [u], f, l) : "operator";
  if (u == "$") {
    var $ = n.pos;
  ...
  if (/[A-Z]/.test(u)) {
    ...
    if (n.eatWhile(/[A-Z_]/), /[\da-z]/.test(t(n, 0)))
      ...
      var i = p[n.current()];
      return i ? (i[1] && (i = i[0]), _ != ":" ? i == 1 ? "keyword" : i == 2 ? "def" : i == 3 ? "atom" : i == 4 ? "operator" : i == 5 ? "builtin" : "meta" : "meta") : "meta";
    }
  }
  if (/[a-zA-Z_]/.test(u)) {
    var _ = t(n, -2);
