...
var R = I.keywords, S = I.fileNCtrlMaskOptions, u = I.externalCommands, P = I.indentStatements !== !1, A = /[\|]/, t;
function L(e, n) {
  var T = e.next();
  if (T == '"' || T == "'")
  ...
  e.eatWhile(/[\w\$_]/);
  var E = e.current();
  return R.propertyIsEnumerable(E) ? "keyword" : S.propertyIsEnumerable(E) ? "atom" : u.propertyIsEnumerable(E) ? "deleted" : "variable";
}
C(L, "tokenBase");
function M(e) {
  return function(n, T) {
    for (var E = !1, o, _ = !1; (o = n.next()) != null; ) {
      if (o == e && !E) {
        var i = n.peek();
        i && (i = i.toLowerCase(), (i == "b" || i == "h" || i == "o") && n.next()), _ = !0;
        break;
      }
      E = !E && o == "\\";
    }
    return _ && (T.tokenize = null), "string";
  };
}
C(M, "tokenString");
function l(e, n, T, E, o) {
  this.indented = e, this.column = n, this.type = T, this.align = E, this.prev = o;
}
C(l, "Context");
function r(e, n, T) {
  var E = e.indented;
  return e.context && e.context.type == "statement" && (E = e.context.indented), e.context = new l(E, n, T, null, e.context);
}
C(r, "pushContext");
function N(e) {
...
const c = {
  ...
  token: /* @__PURE__ */ C(function(e, n) {
    ...
    } else t == T.type ? N(n) : P && ((T.type == "}" || T.type == "top") && t != ";" || T.type == "statement" && t == "newstatement") && r(n, e.column(), "statement");
