...
var s = (r, c) => F(r, "name", { value: c, configurable: !0 });
function l(r) {
  var c = r.client || {}, g = r.atoms || { false: !0, true: !0, null: !0 }, h = r.builtin || e(S), C = r.keywords || e(m), y = r.operatorChars || /^[*+\-%<>!=&|~^\/]/, o = r.support || {}, v = r.hooks || {}, Q = r.dateSQL || { date: !0, time: !0, timestamp: !0 }, j = r.backslashStringEscapes !== !1, L = r.brackets || /^[\{}\(\)\[\]]/, x = r.punctuation || /^[;.,:]/;
  function b(t, i) {
    var a = t.next();
    if (v[a]) {
      var n = v[a](t, i);
    ...
    if (a == ".") {
      ...
      return Q.hasOwnProperty(u) && (t.match(/^( )+'[^']*'/) || t.match(/^( )+"[^"]*"/)) ? "number" : g.hasOwnProperty(u) ? "atom" : h.hasOwnProperty(u) ? "type" : C.hasOwnProperty(u) ? "keyword" : c.hasOwnProperty(u) ? "builtin" : null;
    }
  }
  s(b, "tokenBase");
  function w(t, i) {
  ...
  return s(N, "popContext"), {
    ...
    token: /* @__PURE__ */ s(function(t, i) {
      ...
      var n = t.current();
      return n == "(" ? k(t, i, ")") : n == "[" ? k(t, i, "]") : i.context && i.context.type == n && N(i), a;
    }, "token"),
