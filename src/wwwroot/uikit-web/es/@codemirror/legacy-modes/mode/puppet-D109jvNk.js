...
function f(e, n) {
  for (var i, o, c = !1; !e.eol() && (i = e.next()) != n.pending; ) {
    if (i === "$" && o != "\\" && n.pending == '"') {
      c = !0;
      break;
    }
  ...
  return c && e.backUp(1), i == n.pending ? n.continueString = !1 : n.continueString = !0, "string";
}
t(f, "tokenString");
function d(e, n) {
  var i = e.match(/[\w]+/, !1), o = e.match(/(\s+)?\w+\s+=>.*/, !1), c = e.match(/(\s+)?[\w:_]+(\s+)?{/, !1), s = e.match(/(\s+)?[@]{1,2}[\w:_]+(\s+)?{/, !1), r = e.next();
  if (r === "$")
