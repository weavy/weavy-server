...
var e = (i, n) => O(i, "name", { value: n, configurable: !0 });
function r(i) {
  var n = [];
...
), A = r("IF ELSE THEN BEGIN WHILE REPEAT UNTIL RECURSE [IF] [ELSE] [THEN] ?DO DO LOOP +LOOP UNLOOP LEAVE EXIT AGAIN CASE OF ENDOF ENDCASE");
function t(i, n) {
  var E;
...
const S = {
  ...
  token: /* @__PURE__ */ e(function(i, n) {
    ...
    if (E = i.match(/^(\S+)(\s+|$)/), E)
      return t(n.wordList, E[1]) !== void 0 ? "variable" : E[1] === "\\" ? (i.skipToEnd(), "comment") : t(n.coreWordList, E[1]) !== void 0 ? "builtin" : t(n.immediateWordList, E[1]) !== void 0 ? "keyword" : E[1] === "(" ? (i.eatWhile(function(R) {
        return R !== ")";
      }), i.eat(")"), "comment") : E[1] === ".(" ? (i.eatWhile(function(R) {
        return R !== ")";
      }), i.eat(")"), "string") : E[1] === 'S"' || E[1] === '."' || E[1] === 'C"' ? (i.eatWhile(function(R) {
        return R !== '"';
