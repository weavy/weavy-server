...
var F = "\\\\[0-7]{1,3}", g = "\\\\x[A-Fa-f0-9]{1,2}", b = `\\\\[abefnrtv0%?'"\\\\]`, y = "([^\\u0027\\u005C\\uD800-\\uDFFF]|[\\uD800-\\uDFFF][\\uDC00-\\uDFFF])", p = [
  ...
  "catch",
  "do"
], _ = ["end", "else", "elseif", "catch", "finally"], h = [
  "if",
  "else",
  "elseif",
  "while",
  ...
  "primitive",
  "bitstype"
], s = ["true", "false", "nothing", "NaN", "Inf"], C = u(E), w = u(_), D = u(h), T = u(s), P = /^@[_A-Za-z\u00A1-\uFFFF][\w\u00A1-\uFFFF]*!*/, B = /^:[_A-Za-z\u00A1-\uFFFF][\w\u00A1-\uFFFF]*!*/, O = /^(`|([_A-Za-z\u00A1-\uFFFF]*"("")?))/, S = u(p, "", "@"), G = u(p, "", ":");
function l(e) {
...
function t(e, n) {
  ...
  var c;
  if ((c = e.match(C, !1)) && n.scopes.push(c[0]), e.match(w, !1) && n.scopes.pop(), e.match(/^::(?![:\$])/))
    return n.tokenize = $, n.tokenize(e, n);
  if (!i && (e.match(B) || e.match(G)))
    return "builtin";
  if (e.match(m))
    return "operator";
  if (e.match(/^\.?\d/, !1)) {
  ...
  if (e.match(O))
    return n.tokenize = j(e.current()), n.tokenize(e, n);
...
o(t, "tokenBase");
function $(e, n) {
  return e.match(/.*?(?=[,;{}()=\s]|$)/), e.match("{") ? n.nestedParameters++ : e.match("}") && n.nestedParameters > 0 && n.nestedParameters--, n.nestedParameters > 0 ? e.match(/.*?(?={|})/) || e.next() : n.nestedParameters == 0 && (n.tokenize = t), "builtin";
}
o($, "tokenAnnotation");
function I(e, n) {
  return e.match("#=") && n.nestedComments++, e.match(/.*?(?=(#=|=#))/) || e.skipToEnd(), e.match("=#") && (n.nestedComments--, n.nestedComments == 0 && (n.tokenize = t)), "comment";
}
o(I, "tokenComment");
function Z(e, n) {
  var i = !1, r;
  ...
  return i ? (n.leavingExpr = !0, n.tokenize = t, "string") : (e.match(/^[^']+(?=')/) || e.skipToEnd(), e.match("'") && (n.tokenize = t), "error");
}
o(Z, "tokenChar");
function j(e) {
  ...
  function n(i, r) {
    if (i.eat("\\"))
      ...
      if (i.match(e))
        return r.tokenize = t, r.leavingExpr = !0, "string";
      i.eat(/[`"]/);
    }
